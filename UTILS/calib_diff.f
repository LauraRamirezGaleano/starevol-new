...
C ===============================================================================================================
	...
	double precision l,r,m,alfa,cal,zsx_sol,rsol,lsol,alpha,
     &    x_zc,y_zc,z_zc,zsx_zc,bid,zsx0,x0_c,y0_c,x0,z0,y0,dr,dl,dbeta,
...
C	Solar data (indicatif mais non utilisé !)
	parameter (cal = 1.d-5,xlumsol = 3.828d33, raysol = 6.9551d10 )
...
C       Checking the reference for the solar chemical composition (surface)
	read(5,*)sc
	if (trim(sc).eq.'1') then 
	   ...
	   zsurxsol =  0.018207d0
c       zsurxsol =  0.0180d0
	else if (trim(sc).eq.'4') then
	   zsurxsol = 0.0188d0
	endif
	
	print*,'zsurxsol',zsurxsol
