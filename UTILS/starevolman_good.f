...
c      call getenv('CODEPHYS',refphys)
      refsolar = trim(refsolar)
      print *, 'refsolar starevolman.f', refsolar!,
c     $     'refphys starevolman.f', refphys
...
c         iret=system("clear" )
 ...
 401     format (/,5x,'Choose your option:',//
     ...
     &        3x,'o Asplund, Grevesse, Sauval & Scott 2009 [AGSS09]',/,
     &        3x,'o Asplund et al. 2009 + Ne from Young 2018 [AY18]',//,
     &        '    ---> Enter option',5x,a6)
         read (5,'(a6)') refsolar
         print *,trim(refsolar)
         call solx(refsolar,znew)
...
c     &     form = 'unformatted',convert = 'big_endian',
 ...
 401     format (/,5x,'Choose your option:',//
     ...
     &        3x,'o Grevesse & Sauval 1998            [GS98]',/,
     &        3x,'o Asplund, Grevesse & Sauval 2005   [AGS05]',//,
     &        3x,'o Asplund+2009 + Young 2018 (Ne)    [AY18]',//,         
     &        '    ---> Enter option',5x,a5)
         read (5,'(a6)') refsolar
         call solx(refsolar,znew)
      endif
...
************************************************************************
     ...
     &     FeHsol,fracFe,iheavy
      ...
      if (refsolar.eq.'AY18') refsolchem = 5
...
C       read(5,'(a5)')initsolar
      ...
      if (trim(initsolar).eq.'AY18') refsolchem = 5
...
c..   4.235% Ca + 1.202% Cr + 0.879% Mn + 0.202% Ti 
      ...
      else if (refsolchem.eq.3.or.refsolchem.eq.5) then
