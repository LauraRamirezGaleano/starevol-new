      ...
      include '/home/siess/EVOL/PHYSICS/NUCLEAR/LIB/evolcom.const'
...
c      sbremda = dumda*z + dum*(tfac4*fbremda - tfac5*gbremda) 
c      sbremdz = dumdz*z + dum*(tfac4*fbremdz - tfac5*gbremdz) 
...
c      sbremda = dumda*z + dum*(tfac4*fliqda - tfac5*gliqda) 
c      sbremdz = dumdz*z + dum*(tfac4*fliqdz - tfac5*gliqdz) 
