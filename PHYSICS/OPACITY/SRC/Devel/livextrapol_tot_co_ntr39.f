...
c     . new version compatible with the Gz???.x??? opacity tables
     ...
     &     ofrac(ntab1)
      ...
      open (unit = 10,file = 
     &     '/home/siess/EVOL/PHYSICS/OPACITY/SRC/Data/' // 
     &     trim(name) // '_src')
...
c#               write(*,'(i3,i3,f7.3,2x,0pf7.3,2x,f11.0,2x,1pe10.4,2x,
c#     &              1pe10.4,2x,1pe10.4,2x,1pe11.4,2x,1pe11.4)') k
c#     &              ,l,logT(k),logR(l),temp_row(1),den_row(1),ocond,opac
c#     &              ,ee,cof(k,l)
            enddo
         enddo
c#         stop
