...
c
c    computes partial derivatives for OPAL04+FERG04
...
c     read the opacity-tables (OPAL95 + ALEX94)
      ...
      call rdi05(lun,optabe,ntab,nxir,nyir,nzva,rlg,tlg,opa,ival)
      print *,'read ALEX94 tables...'
      call readferg(lun+2,lowtab,ntab,nzva,nxir,ntal,rlgal,tlgal,opaal)
c
