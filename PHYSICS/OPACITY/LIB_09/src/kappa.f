...
c      double precision yopa,y1opa,y2opa,y12opa
     ...
     &     yyopa1,yyopa2,yyopa3,yyopa4,kap4,kapr4,kapt4
      ...
      double precision logR,Pdyne

      logical idiffcc,idiffcc0,rotation,diffusconv,diffover,difftacho,
     &     microdiffus
...
c      dimension yopa(4),y1opa(4),y2opa(4),y12opa(4)
      ...
      common /difftype/ idiffty,rotation,diffover,diffusconv,
     &     difftacho,microdiffus
...
*------------------------------------------------------------------------
       ...
       if (tk.le.4.5d3.and.nretry.eq.1) then

         call opa_co (kap1,kapr1,kapt1,error)
         kapx1 = 0.d0
         kapy1 = 0.d0
...
c     &           uopa,ck(j),ckr(j),ckt(j))
 70      continue
     ...
     &        xsi12*xsi1*ckt(1)
         kap1 = exp(kap4*vlog10)
         kapr1 = kap1*kapr4/rok
         kapt1 = kap1*(-3.d0*kapr4/tk+kapt4*vlog10)
         kapx1 = 0.d0
         kapy1 = 0.d0
