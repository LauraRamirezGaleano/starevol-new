...
pulse/DUP  \\ \hline 
\HPT{mtinit} & $M_\odot$ & Initial stellar mass.
\\ \hline 
\HPT{zkint} & $Z_{\mathrm{tab}}$ & Metallicity to
be selected in the Livermore opacity tables \LA{, to be selected accordingly to the chosen solar calibration.} \\ \hline\hline
...
{\HPT{idup}} & 0, 1, 2, 3 & (1) find neutrality of the
