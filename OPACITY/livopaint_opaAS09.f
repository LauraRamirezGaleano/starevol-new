...
c  n_zmixes = 7 = number of "hz" opacity files available (the fifth one is for
...
c /opalmixes/ data:
c
      data cfile_opalmixes/'AGSS09hz','AGS05hz ','GN93hz  ','Alrd96a2'
     $     ,'C95hz   ','W95hz   ','        '/
...
c
     ...
     $     'GS98hz_OFe.4_C95', 'GS98hz_OFe.5_W95', 8 * ' ' /
c
